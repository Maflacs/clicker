...
function App() {
    ...
    const handleLearningsClicked = (index) => {
        const clickedLearning = state.learningList[index];
        if (state.knowledge >= clickedLearning.price) {
            const newLearnings = [...state.learningList];
            newLearnings[index] = {
                ...newLearnings[index],
        ...
        <div className={getClassName()}>
            ...
            <main className="main-container">
                <section className="inventory-container per-click">
                    <Learnings learnings={state.learningList} onClick={handleLearningsClicked} />
                </section>
